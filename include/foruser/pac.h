...
//char blockface_id[7];                  /*blockface id 10 bytes long*/
  char filler05[7];                      /* moved in wa2 of F1EX     */
  char status;                           /*                          */
  char str_width[3];                     /*                          */
